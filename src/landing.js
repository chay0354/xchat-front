    ...
    <div className={`landing-root ${theme === 'dark' ? 'theme-dark' : 'theme-light'}`}>
          ...
          <section className="landing-hero">
            ...
            <p className="landing-hero__subtitle">
              {isLoggedIn
                ...
                : 'תן לנו את כתובת האתר שלך, ואנחנו נבנה אוטומטית צ\'אט-בוט חכם שיודע הכל על העסק שלך. 14-יום ניסיון. אין צורך בכרטיס אשראי.'
              }
            </p>
      ...
      <footer className="landing-footer">
        ...
        <p className="landing-footer__text">
          flowchat © מבית stealthCode. המלאכה 16 ראש-העין. 054-5779917
        </p>
      </footer>
    </div>
  );
